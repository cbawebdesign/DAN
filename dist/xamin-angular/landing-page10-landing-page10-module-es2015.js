...
let DataDazzleComponent = class DataDazzleComponent {
    constructor() {
        this.List = [
            {
                title: 'Infographics',
...
let OurCounterComponent = class OurCounterComponent {
    constructor() {
        this.List = [
...
let RequestDemoComponent = class RequestDemoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let RevolutionSlider10Component = class RevolutionSlider10Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let RevolutionSlider10Module = class RevolutionSlider10Module {
};
...
let TipsTricksComponent = class TipsTricksComponent {
    constructor() {
        this.titleSectionProp = {
            class: 'text-left',
            title: '',
...
let VisualsComponent = class VisualsComponent {
    constructor() {
        this.titleSectionProp = {
            class: 'text-left',
            title: '',
...
let LandingPage10Module = class LandingPage10Module {
};
